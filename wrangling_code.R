...
data_oil_csmpt <- read_csv(paste0(path, "/oil_consumption_per_cap.csv"), col_names = T)
...
# combine data_oil_csmpt and data_co2_emis_2
data_all <- left_join(data_oil_csmpt, data_co2_emis_2, by = "country")
